...
namespace Stratsys.Apis.v1.ExampleTests.Apis.Scorecards
{
    public class ScorecardViewServiceUT : BaseTest
    {
        ...
        {
            var url = Api.ScorecardViews.GetUrl("124", nodeId: "21412").Fetch().Result;
            Assert.That(url, Is.EqualTo("https://www.stratsys.se/PermaLink/ApiPublicTests/ScorecardView.mvc?keyId=124&MenuContainerId=502&NodeIdentifierId=21412"));
        }
